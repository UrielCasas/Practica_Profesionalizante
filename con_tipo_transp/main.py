...
def procesar_df():
    try:
        ...
        df = df.groupby(['DIA_TRANSPORTE', 'TIPO_TRANSPORTE'], sort=False)['CANT_TRJ'].sum().reset_index()
        print(len(df))
        print(df.head())
...
def grafico_barras_dias():
    ...
    colores = ["#66BB6A", "#FFD54F", "#FF4744", "#90CAF9", "#337600", "#FF9A4E", "#BF8AFB"]  # verde, amarillo, rojo, celeste, verde oscuro, naranja, lila 
