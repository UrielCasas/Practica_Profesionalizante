...
X          = None
y          = None
directorio = f"{os.path.dirname(__file__)}/csv/" # nombre del directorio donde están los archivos
...
notebook.add(tab1, text='Aplicación')
notebook.add(tab2, text='Manual')
notebook.add(tab3, text='Información')
