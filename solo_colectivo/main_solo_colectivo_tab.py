...
class VisorPdf(ttk.Frame):
    def __init__(self, parent):
        ...
        # 2. Configurar el estilo 'Grande.TButton'
        # font=('NombreFuente', Tamaño, 'bold'/'normal'/'italic')
        self.style.configure('Grande.TButton', font=('Arial', 14), padding=2)
...
manual_tab  = VisorPdf(notebook)
informe_tab = VisorPdf(notebook)
