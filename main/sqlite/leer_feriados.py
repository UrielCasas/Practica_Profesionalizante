...
root.protocol("WM_DELETE_WINDOW", cerrando)

ttk.Button(root, text="Feriado", command=marcar_feriado).place(y=210, x=80)
ttk.Button(root, text="No Feriado", command=desmarcar_feriado).place(y=210, x=180)

ttk.Button(root, text="Cerrar", command=cerrando).place(y=260, x=250)
